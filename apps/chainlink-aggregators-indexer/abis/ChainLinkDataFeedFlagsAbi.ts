export const ChainLinkDataFeedFlagsAbi = [
	{
		inputs: [
			{ internalType: "address", name: "racAddress", type: "address" },
			{ internalType: "address", name: "lacAddress", type: "address" },
		],
	...
	{
		inputs: [{ internalType: "address", name: "lacAddress", type: "address" }],
	...
	{
		inputs: [{ internalType: "address", name: "racAddress", type: "address" }],
